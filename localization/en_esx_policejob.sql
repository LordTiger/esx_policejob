...
INSERT INTO `addon_account` (name, label, shared) VALUES
	('society_police', 'San Andreas State Police', 1)
;
...
INSERT INTO `jobs` (name, label) VALUES
	('police', 'San Andreas State Police')
;

INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('police',0,'Probationary Trooper','',20,'{}','{}'),
	('police',1,'officer','Trooper',40,'{}','{}'),
	('police',2,'srofficer','Senior Trooper',60,'{}','{}'),
	('police',3,'sergeant','Sergeant',85,'{}','{}'),
	('police',4,'lieutenant','Lieutenant',100,'{}','{}'),
	('police',5,'cap','Captain',100,'{}','{}'),
	('police',6,'commander','Major',100,'{}','{}'),
	('police',7,'dchief','Lt. Colonel',100,'{}','{}'),
	('police',8,'boss','Colonel',100,'{}','{}')
